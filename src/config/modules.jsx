  ...
  CHECKLISTFORM: {
    ...
    children: {
      COBS: {
        ...
        displayName: "COBS Questionnaires",
        path: "cobs",
      ...
      PEST_SHEETS: {
        ...
        displayName: "PESTS Questionnaires",
        path: "pest-sheets",
        icon: <BugReportIcon sx={iconStyles.child} />,
      },
      BIRDS: {
        ...
        displayName: "BIRDS Questionnaires",
        path: "birds",
  ...
  APPROVAL: {
    ...
    children: {
      COBS: {
        ...
        displayName: "COBS Acknowledgement",
        path: "cobs",
        icon: <SanitizerIcon sx={iconStyles.child} />,
      },
      BIRDS: {
        ...
        displayName: "BIRDS Acknowledgement",
        path: "birds",
        icon: <FlutterDashIcon sx={iconStyles.child} />,
      },
      PESTS: {
