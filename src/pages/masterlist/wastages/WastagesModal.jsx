...
const SkeletonLoader = () => (
  <div className="wm__skeleton-wrap">
    <div className="wm__skeleton-group">
      <span className="ut__skeleton wm__skeleton-label" />
      <span className="ut__skeleton wm__skeleton-field" />
    </div>
    <div className="wm__skeleton-footer">
      <span className="ut__skeleton wm__skeleton-btn" />
    </div>
  </div>
);
