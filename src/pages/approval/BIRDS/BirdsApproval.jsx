...
import { useGetBirdsApprovalsQuery } from "../../../features/api/approval/birdsApproval";
import BirdsApprovalModal from "./BirdsApprovalModal";
import "./BirdsApproval.scss";
...
const BirdsApproval = () => {
  ...
  const { data, isFetching, error } = useGetBirdsApprovalsQuery(
    { status: "pending" },
